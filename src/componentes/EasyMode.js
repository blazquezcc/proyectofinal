...
const EasyMode = () => {
    ...
    const startTimer = (e) => {
        ...
        if(  document.getElementById("tiempo").innerHTML== "40"){
         
            var opciones = texto.split(",");
            var posicionAleatoria = Math.floor(Math.random() * opciones.length);
            document.getElementById("palabra").innerHTML =opciones[posicionAleatoria];
        }
        if(  document.getElementById("tiempo").innerHTML== "30"){
            
            var opciones = texto.split(",");
            var posicionAleatoria = Math.floor(Math.random() * opciones.length);
            document.getElementById("palabra").innerHTML =opciones[posicionAleatoria];
        }
        if(  document.getElementById("tiempo").innerHTML== "20"){
           
            var opciones = texto.split(",");
            var posicionAleatoria = Math.floor(Math.random() * opciones.length);
            document.getElementById("palabra").innerHTML =opciones[posicionAleatoria];
        }
        if(  document.getElementById("tiempo").innerHTML== "10"){
    ...
    return(
        <div class="container">
       <h2 class="my-3 h2">Easy Mode</h2>
       <h2  class="my-3 h3" id="tiempo">{timer}</h2>
       <p id="palabra"></p>
