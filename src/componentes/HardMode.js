...
const HardMode = () => {
    ...
    return(
        <div class="container">
       <h2 class="my-3 h2">Hard Mode</h2>
       <h2 id="tiempo2">{timer}</h2>
       <p id="palabra2"></p>
