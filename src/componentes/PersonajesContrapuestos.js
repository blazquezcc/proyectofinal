...
const TematicasImagenes = () => {
    ...
    const startTimer = (e) => {
        ...
        var texto7 = "Batman vs Superman,Real Madrid vs Barcelona,Messi vs Cristiano,España vs Francia,Capitan America vs Ironman,Vegeta vs Goku,Naruto vs Sasuke,Ash vs Gary,Smite vs Lol,CSGO vs Valorant,Redbull vs Monster,Apple vs Android,Twitch vs Youtube,Vegeta vs Willyrex,Dios vs Satanas,Pasado vs Futuro,LQSA VS ANHQV,Delantero vs Portero,Xbox vs PS,Instagram vs Twitter, Steam vs EpicGame, Amazon vs AliExpress";
        if(  document.getElementById("tiempo7").innerHTML== "58"){
           
            var opciones7 = texto7.split(",");
            var posicionAleatoria7 = Math.floor(Math.random() * opciones7.length);
            document.getElementById("palabra7").innerHTML =opciones7[posicionAleatoria7];
        }
    ...
    return(
        <div class="container">
       <h2 class="my-3 h2">Personajes Contrapuestos</h2>
       <h2 id="tiempo7">{timer}</h2>
       <p id="palabra7"></p>
...
export default TematicasImagenes;